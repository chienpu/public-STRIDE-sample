...
This repository contains selected artifacts from the **STRIDE (SemanTic Reasoning and Integration for Data-driven Engineering)** framework. It supports journal peer review by demonstrating the core concepts of ontology-driven predictive maintenance using Neo4j and Python.
